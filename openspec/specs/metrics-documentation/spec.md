# metrics-documentation Specification

## Purpose

Generate a browsable Markdown reference table (`docs/METRICS.md`) from the metric catalog, and link it from the project's README so the full set of readiness metrics is discoverable outside the CLI.
